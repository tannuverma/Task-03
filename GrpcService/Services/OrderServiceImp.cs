...
namespace GrpcService.Services
{
    public class OrderServiceImp : OrderService.OrderServiceBase
    {
        ...
        public OrderServiceImp()
        {
            ...
            string filePath = @"C:\Users\tannuverma\Desktop\MicroserviceDemo\GrpcService\Data\products.json";
        ...
        private void SaveProductsToFile()
        {
            ...
            File.WriteAllText(@"C:\Users\tannuverma\Desktop\MicroserviceDemo\GrpcService\Data\products.json", json);
            }
            catch (Exception ex)
            {
